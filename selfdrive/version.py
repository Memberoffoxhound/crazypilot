...
TESTED_BRANCHES = ['devel', 'release2-staging', 'release3-staging', 'dashcam-staging', 'release2', 'release3', 'dashcam', 'FrogPilot']
...
def get_comma_remote() -> bool:
  ...
  return origin.startswith('git@github.com:FrogAi') or origin.startswith('https://github.com/FrogAi')
