...
class StartupAlert(Alert):
  def __init__(self, alert_text_1: str, alert_text_2: str = "so I do what I want", alert_status=AlertStatus.normal):
    super().__init__(alert_text_1, alert_text_2,
...
EVENTS: Dict[int, Dict[str, Union[Alert, AlertCallbackType]]] = {
  ...
  EventName.startup: {
    ET.PERMANENT: StartupAlert("Hippity hoppity this is my property")
  },
  ...
  EventName.overheat: {
    ET.WARNING: NormalPermanentAlert("System Overheated"),
  },

  EventName.wrongGear: {
    ET.NO_ENTRY: NoEntryAlert("Vehicle not in Drive"),
  },
  ...
  EventName.doorOpen: {
    ET.WARNING: NormalPermanentAlert("Door Open"),
  },

  EventName.seatbeltNotLatched: {
    ET.WARNING: NormalPermanentAlert("Seatbelt Unlatched"),
  },
  ...
  EventName.reverseGear: {
    ET.WARNING: NormalPermanentAlert("Vehicle is in Reverse"),
  },
